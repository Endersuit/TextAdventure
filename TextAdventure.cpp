...
int main()
{
    Creature* player = new Creature("Kalagan", 15, 4, 1, false, std::make_unique<IncendiaryBomb>());
    ...
    std::unique_ptr<Creature> endermite = std::make_unique<Creature>("Endermite", 5, 1, 1, true, nullptr);
